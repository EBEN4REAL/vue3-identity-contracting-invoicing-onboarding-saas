...
export interface paths {
    ...
    "/agreement-types": {
        ...
        /** Retrieves the Agreement Types */
        get: operations["agreement_types_read_agreement_types_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/policy-types": {
        ...
        /** Returns the Policy Types */
        get: operations["policy_types_read_policy_types_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** AgreementTypeWithServiceProviderRead */
        AgreementTypeWithServiceProviderRead: {
            /**
             * Id
             * Format: uuid
            ...
            /** Description */
            description?: string | null;
            service_provider?: components["schemas"]["ServiceProviderBaseRead"] | null;
        };
        /** AgreementUsageRead */
        AgreementUsageRead: {
            /** External Facing Name */
        ...
        /** PaginationSchema[AgreementTypeWithServiceProviderRead] */
        PaginationSchema_AgreementTypeWithServiceProviderRead_: {
            /** Offset */
            offset: number;
            /** Limit */
            limit: number;
            /** Results */
            results: components["schemas"]["AgreementTypeWithServiceProviderRead"][];
            /** Size */
            size: number;
            /** Total */
            total?: number | null;
        ...
        /** PaginationSchema[PolicyTypeWithServiceProviderRead] */
        PaginationSchema_PolicyTypeWithServiceProviderRead_: {
            /** Offset */
            offset: number;
            /** Limit */
            limit: number;
            /** Results */
            results: components["schemas"]["PolicyTypeWithServiceProviderRead"][];
            /** Size */
            size: number;
            /** Total */
            total?: number | null;
         ...
         * @enum {string}
         */
        PolicyAssignmentStatus: "PENDING" | "ACCEPTED" | "REJECTED";
        /**
        ...
        /** PolicyTypeWithServiceProviderRead */
        PolicyTypeWithServiceProviderRead: {
            /**
             * Id
             * Format: uuid
...
export interface operations {
    ...
    policy_types_read_service_providers__service_provider_id__policy_types_get: {
        parameters: {
            query?: {
                ...
                query?: string | null;
                /** @description Attribute used to sort the Policy Types: ['service_provider_id', 'category_id', 'name', 'outcome', 'audit_level', 'troubleshoot', 'troubleshoot_end', 'external_facing_name'] */
                sort?: string | null;
            };
            header?: never;
            path: {
    ...
    get_organization_users_external_policies_service_providers__service_provider_id__policies_external_organization_users_get: {
        parameters: {
            query?: {
                ...
                query?: string | null;
                /** @description Attribute used to sort the Policies: ['name', 'description', 'external_facing_name', 'external_facing_description'] */
                sort?: string | null;
            };
            header?: never;
            path: {
    ...
    get_organizations_external_policies_service_providers__service_provider_id__policies_external_organizations_get: {
        parameters: {
            query?: {
                ...
                /** @description A search query is used to search policies using (policy type name, description, ) */
                query?: string | null;
                /** @description Attribute used to sort the Policies: ['policy.owner_id', 'policy.assigned_by_id', 'policy.resource_owner_id', 'policy.type_id', 'policy.valid_from', 'policy.valid_until', 'policy.optional', 'policy.agreement_id', 'policy_type.name', 'policy_type.external_facing_name'] */
                sort?: string | null;
            };
            header?: never;
            path: {
    ...
    get_all_external_policies_service_providers__service_provider_id__policies_external_all_get: {
        parameters: {
            query?: {
                ...
                /** @description A search query is used to search policies using (policy type name, description, ) */
                query?: string | null;
                /** @description Attribute used to sort the Policies: ['id', 'owner_id', 'assigned_by_id', 'resource_owner_id', 'type_id', 'assigned_on', 'valid_from', 'valid_until', 'optional', 'agreement_id', 'name', 'external_facing_name'] */
                sort?: string | null;
            };
            header?: never;
            path: {
    ...
    agreement_types_read_agreement_types_get: {
        parameters: {
            query?: {
                /** @description Agreement Types Offset */
                offset?: number;
                /** @description Max number of Agreement Types */
                limit?: number;
                /** @description A search query is used to search Agreement Types using (name, description, ) */
                query?: string | null;
                /** @description Attribute used to sort the Agreement Type: ['agreement_type.name'] */
                sort?: string | null;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PaginationSchema_AgreementTypeWithServiceProviderRead_"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    policy_types_read_policy_types_get: {
        parameters: {
            query?: {
                /** @description Policy Types Offset */
                offset?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PaginationSchema_PolicyTypeWithServiceProviderRead_"];
                };
            };
            /** @description Unauthorized */
            401: {
