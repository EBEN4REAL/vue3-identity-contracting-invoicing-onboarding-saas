...
const formUrl: ComputedRef<string> = computed(
  () =>
    `${config.idp.url}/signup/email-otp?next_url=${encodeURIComponent(`${route.query.next_url}`)}`,
);
...
<template>
  <div class="mm-auth-view-email-otp">
    ...
    <div data-cy="verification-required">
      ...
      <div>
        <div class="mm-flex mm-flex-justify-center">
          <m-m-link
            prepend-icon="arrow-left"
            :href="backTo"
            data-cy="button-email-otp-back-to"
          >
