...
export interface paths {
    ...
    "/service-providers/{service_provider_id}/configs/{config_id}/changes": {
        ...
        /** Returns the Changes associated with a Config */
    ...
    "/service-providers/{service_provider_id}/policy-types/{policy_type_id}/entitlements": {
        ...
        /** Retrieves the Entitlements associated with a Policy Type for a Service Provider */
    ...
    "/service-providers/{service_provider_id}/policy-types/{policy_type_id}/roles": {
        ...
        /** Retrieves the Roles associated with a Policy Type for a Service Provider */
    ...
    "/configs": {
        ...
        /** Returns the Configs */
        get: operations["configs_read_configs_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/configs/{config_id}": {
        ...
        /** Returns a Config */
        get: operations["config_read_configs__config_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/wizards": {
        ...
        /** Returns the Wizards */
        get: operations["wizards_read_wizards_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/wizards/{wizard_id}": {
        ...
        /** Returns a Wizard */
        get: operations["wizard_read_wizards__wizard_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ConfigExtendedRead: {
            ...
            service_provider: components["schemas"]["ServiceProviderRead"];
            /** Changes */
            changes: components["schemas"]["ConfigChangeRead"][];
            /** Services */
            services: components["schemas"]["ConfigServiceRead"][];
        };
        /** ConfigOverviewRead */
        ConfigOverviewRead: {
            /**
        ...
        /** PaginationSchema[ConfigOverviewRead] */
        PaginationSchema_ConfigOverviewRead_: {
            /** Offset */
            offset: number;
            /** Limit */
            limit: number;
            /** Results */
            results: components["schemas"]["ConfigOverviewRead"][];
            /** Size */
            size: number;
            /** Total */
            total?: number | null;
        ...
        /** PaginationSchema[WizardExtendedRead] */
        PaginationSchema_WizardExtendedRead_: {
            /** Offset */
            offset: number;
            /** Limit */
            limit: number;
            /** Results */
            results: components["schemas"]["WizardExtendedRead"][];
            /** Size */
            size: number;
            /** Total */
            total?: number | null;
         ...
         * @enum {string}
         */
        Service: "IAM" | "ONBOARDING" | "POLICIES" | "EVENTS" | "CONTRACTING" | "BILLING" | "CONFIGURATION";
...
export interface operations {
    ...
    config_change_read_service_providers__service_provider_id__configs__config_id__changes_get: {
        ...
        requestBody?: never;
        responses: {
            /** @description Config Changes Returned */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Missing Service Provider or Missing Config */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    policy_types_read_service_providers__service_provider_id__policy_types_get: {
        parameters: {
            query?: {
                ...
                query?: string | null;
                /** @description Attribute used to sort the Policy Types: ['service_provider_id', 'category_id', 'name', 'outcome', 'audit_level', 'troubleshoot', 'troubleshoot_end', 'created_date', 'external_facing_name'] */
                sort?: string | null;
            };
            header?: never;
            path: {
    ...
    configs_read_configs_get: {
        parameters: {
            query?: {
                /** @description Offset */
                offset?: number;
                /** @description Max number of Configs */
                limit?: number;
                /** @description A search query is used to search Configs using name */
                query?: string | null;
                /** @description Attribute used to sort the Configs: ['created_date', 'status_updated_date', 'status'] */
                sort?: string | null;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PaginationSchema_ConfigOverviewRead_"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    config_read_configs__config_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ConfigExtendedRead"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    wizards_read_wizards_get: {
        parameters: {
            query?: {
                /** @description Offset */
                offset?: number;
                /** @description Max number of Wizards */
                limit?: number;
                /** @description A search query is used to search Wizard Types using name */
                query?: string | null;
                /** @description Attribute used to sort the Wizards: ['name'] */
                sort?: string | null;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PaginationSchema_WizardExtendedRead_"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    wizard_read_wizards__wizard_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WizardExtendedRead"];
                };
            };
            /** @description Unauthorized */
            401: {
