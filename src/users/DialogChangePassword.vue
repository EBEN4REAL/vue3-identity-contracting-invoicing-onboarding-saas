...
const changePasswordForm = reactive<TypeChangePasswordForm>({
  old: "",
  new: "",
});
...
const formRules: ComputedRef<TypeChangePasswordFormRules> = computed(() => ({
  old: passwordRules.value,
...
const submitForm = async () => {
  ...
  try {
    loading.value = true;
    await usersService.changeUserMePassword(
      changePasswordForm.old,
